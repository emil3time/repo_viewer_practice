...
class OAuth2Interceptor extends Interceptor {
  ...
  Future<void> onError(DioError err, ErrorInterceptorHandler handler) async {
    ...
    if (errorResponse != null && errorResponse.statusCode == 401) {
      ...
      // = : credentials == null go to change status and send to signIn Page
      await _authNotifier.checkAndUpdateAuthStatus();
      // = ? _dio.fetch -retry request || ..header (cascade operator) - do something
      // (change 'Authorization' )  and after  that return header
